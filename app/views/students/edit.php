...
<body class="min-h-screen flex flex-col bg-gray-100">
    ...
    <header class="bg-blue-500 text-white">
        <div class="flex items-center justify-between container mx-auto p-4">
            ...
            <a href="/students/create" class="bg-white text-blue-500 px-4 py-2 rb-20 rounded-lg font-bold">+ Tambah Siswa</a>
        </div>
    </header>
    <!-- Header End -->
            ...
            <div class="bg-white shadow rounded-lg">
                <form action="" class="p-4 grid grid-cols-2 gap-4">
                    ...
                    <div class="flex justify-end gap-4 col-span-2">
                        ...
                        <button type="submit" class="py-2 px-4 bg bg-blue-500 rounded-lg text-white">Simpan</button>
                    </div>
                </form>
            </div>
            <!-- Card Content End -->
